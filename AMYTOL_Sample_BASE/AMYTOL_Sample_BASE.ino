...
#define LED
 ...
 unsigned long prvMilsLED_R = 2600UL;
  unsigned long prvMilsLED_GAR = 2600UL;
//#define PIXELSTRIPS
 #include <FastLED.h>
...
//#define SERVO
 ...
 unsigned long prvMilsSERVO_F = 2600UL;
  unsigned long prvMilsSERVO_R = 2600UL;
//#define ULTRASONIC
 #include <NewPing.h>
...
void setup()
{
 ...
 // FastLED.addLeds<WS2812, FastLED_Pin_F, RGB>(leds, NUM_LEDS);//GRB order is typical
  ...
  servo_motor.attach(5); // Setup servo
...
{unsigned long currentMillis = millis(); // Current Time
 ...
 if (currentMillis - prvMilsLED_GAR > 2330)
 {digitalWrite(LED_Green, HIGH);
 digitalWrite(LED_Amber, HIGH);
 digitalWrite(LED_Red, HIGH);}
 if (currentMillis - prvMilsLED_GAR > 2580)
 {digitalWrite(LED_Green, LOW);
 digitalWrite(LED_Amber, HIGH);
 digitalWrite(LED_Red, LOW);}
 if (currentMillis - prvMilsLED_GAR > 3580)
 {digitalWrite(LED_Green, HIGH);
 digitalWrite(LED_Amber, HIGH);
 digitalWrite(LED_Red, HIGH);;  prvMilsLED_GAR = currentMillis;}
 #endif
...
#endif
#ifdef SERVO
 if (currentMillis - prvMilsSERVO_F > 5500)
 {servo_motor.write(50);}
 if (currentMillis - prvMilsSERVO_F > 6000)
 {servo_motor.write(75);}
 if (currentMillis - prvMilsSERVO_F > 7000)
 {servo_motor.write(100);}
 if (currentMillis - prvMilsSERVO_F > 7500)
 {servo_motor.write(125);}
 if (currentMillis - prvMilsSERVO_F > 8000)
 {servo_motor.write(150);}
 if (currentMillis - prvMilsSERVO_F > 8500)
 {servo_motor.write(125);}
 if (currentMillis - prvMilsSERVO_F > 9000)
 {servo_motor.write(100); prvMilsSERVO_F = currentMillis;}

 if (currentMillis - prvMilsSERVO_R > 15500)
 {servo_motor.write(150);}
 if (currentMillis - prvMilsSERVO_R > 16000)
 {servo_motor.write(100);}
 if (currentMillis - prvMilsSERVO_R > 16500)
 {servo_motor.write(50);}
 if (currentMillis - prvMilsSERVO_R > 17000)
 {servo_motor.write(100); prvMilsSERVO_R = currentMillis;}
