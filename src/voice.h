...
#ifdef BITTLE
const char voice1[] PROGMEM = "kpu1";                                 // Push up 单手俯卧撑	 single-handed pushups
#elif defined NYBBLE
const char voice1[] PROGMEM = "kwsf";                                 //洗脸	  wash face
#endif
const char voice3[] PROGMEM = "m0 80 0 -80";                          // Do This 动头 move head Say No!
const char voice2[] PROGMEM = "kmw";                                  // Moonwalk
const char voice4[] PROGMEM = "b14,8,14,8,21,8,21,8,23,8,23,8,21,4";  // Sing 小星星 twinkle star Sing
const char voice5[] PROGMEM = "kff";                                   // Flip
const char voice6[] PROGMEM = "ktrF";                                 // Trott trF
const char voice7[] PROGMEM = "krl";                                  // Gait
const char voice8[] PROGMEM = "kwh";                                   // Want This
const char voice9[] PROGMEM = "kbdF";                                  // Bound
const char voice10[] PROGMEM = "kcalib";  // BEN
